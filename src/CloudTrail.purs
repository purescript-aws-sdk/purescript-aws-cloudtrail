...
addTags = Request.request service method  where
    service = Request.ServiceName "CloudTrail"
...
createTrail = Request.request service method  where
    service = Request.ServiceName "CloudTrail"
    method = Request.MethodName "createTrail"
...
deleteTrail = Request.request service method  where
    service = Request.ServiceName "CloudTrail"
    method = Request.MethodName "deleteTrail"
...
describeTrails = Request.request service method  where
    service = Request.ServiceName "CloudTrail"
    method = Request.MethodName "describeTrails"
...
getEventSelectors = Request.request service method  where
    service = Request.ServiceName "CloudTrail"
    method = Request.MethodName "getEventSelectors"
...
getTrailStatus = Request.request service method  where
    service = Request.ServiceName "CloudTrail"
    method = Request.MethodName "getTrailStatus"
...
listPublicKeys = Request.request service method  where
    service = Request.ServiceName "CloudTrail"
    method = Request.MethodName "listPublicKeys"
...
lookupEvents = Request.request service method  where
    service = Request.ServiceName "CloudTrail"
    method = Request.MethodName "lookupEvents"
...
putEventSelectors = Request.request service method  where
    service = Request.ServiceName "CloudTrail"
    method = Request.MethodName "putEventSelectors"
...
startLogging = Request.request service method  where
    service = Request.ServiceName "CloudTrail"
    method = Request.MethodName "startLogging"
...
stopLogging = Request.request service method  where
    service = Request.ServiceName "CloudTrail"
    method = Request.MethodName "stopLogging"
...
updateTrail = Request.request service method  where
    service = Request.ServiceName "CloudTrail"
    method = Request.MethodName "updateTrail"
...
newAddTagsRequest' :: String -> ( { "ResourceId" :: (String) , "TagsList" :: NullOrUndefined.NullOrUndefined (TagsList) } -> {"ResourceId" :: (String) , "TagsList" :: NullOrUndefined.NullOrUndefined (TagsList) } ) -> AddTagsRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCreateTrailRequest' :: String -> String -> ( { "Name" :: (String) , "S3BucketName" :: (String) , "S3KeyPrefix" :: NullOrUndefined.NullOrUndefined (String) , "SnsTopicName" :: NullOrUndefined.NullOrUndefined (String) , "IncludeGlobalServiceEvents" :: NullOrUndefined.NullOrUndefined (Boolean) , "IsMultiRegionTrail" :: NullOrUndefined.NullOrUndefined (Boolean) , "EnableLogFileValidation" :: NullOrUndefined.NullOrUndefined (Boolean) , "CloudWatchLogsLogGroupArn" :: NullOrUndefined.NullOrUndefined (String) , "CloudWatchLogsRoleArn" :: NullOrUndefined.NullOrUndefined (String) , "KmsKeyId" :: NullOrUndefined.NullOrUndefined (String) } -> {"Name" :: (String) , "S3BucketName" :: (String) , "S3KeyPrefix" :: NullOrUndefined.NullOrUndefined (String) , "SnsTopicName" :: NullOrUndefined.NullOrUndefined (String) , "IncludeGlobalServiceEvents" :: NullOrUndefined.NullOrUndefined (Boolean) , "IsMultiRegionTrail" :: NullOrUndefined.NullOrUndefined (Boolean) , "EnableLogFileValidation" :: NullOrUndefined.NullOrUndefined (Boolean) , "CloudWatchLogsLogGroupArn" :: NullOrUndefined.NullOrUndefined (String) , "CloudWatchLogsRoleArn" :: NullOrUndefined.NullOrUndefined (String) , "KmsKeyId" :: NullOrUndefined.NullOrUndefined (String) } ) -> CreateTrailRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCreateTrailResponse' :: ( { "Name" :: NullOrUndefined.NullOrUndefined (String) , "S3BucketName" :: NullOrUndefined.NullOrUndefined (String) , "S3KeyPrefix" :: NullOrUndefined.NullOrUndefined (String) , "SnsTopicName" :: NullOrUndefined.NullOrUndefined (String) , "SnsTopicARN" :: NullOrUndefined.NullOrUndefined (String) , "IncludeGlobalServiceEvents" :: NullOrUndefined.NullOrUndefined (Boolean) , "IsMultiRegionTrail" :: NullOrUndefined.NullOrUndefined (Boolean) , "TrailARN" :: NullOrUndefined.NullOrUndefined (String) , "LogFileValidationEnabled" :: NullOrUndefined.NullOrUndefined (Boolean) , "CloudWatchLogsLogGroupArn" :: NullOrUndefined.NullOrUndefined (String) , "CloudWatchLogsRoleArn" :: NullOrUndefined.NullOrUndefined (String) , "KmsKeyId" :: NullOrUndefined.NullOrUndefined (String) } -> {"Name" :: NullOrUndefined.NullOrUndefined (String) , "S3BucketName" :: NullOrUndefined.NullOrUndefined (String) , "S3KeyPrefix" :: NullOrUndefined.NullOrUndefined (String) , "SnsTopicName" :: NullOrUndefined.NullOrUndefined (String) , "SnsTopicARN" :: NullOrUndefined.NullOrUndefined (String) , "IncludeGlobalServiceEvents" :: NullOrUndefined.NullOrUndefined (Boolean) , "IsMultiRegionTrail" :: NullOrUndefined.NullOrUndefined (Boolean) , "TrailARN" :: NullOrUndefined.NullOrUndefined (String) , "LogFileValidationEnabled" :: NullOrUndefined.NullOrUndefined (Boolean) , "CloudWatchLogsLogGroupArn" :: NullOrUndefined.NullOrUndefined (String) , "CloudWatchLogsRoleArn" :: NullOrUndefined.NullOrUndefined (String) , "KmsKeyId" :: NullOrUndefined.NullOrUndefined (String) } ) -> CreateTrailResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newDataResource' :: ( { "Type" :: NullOrUndefined.NullOrUndefined (String) , "Values" :: NullOrUndefined.NullOrUndefined (DataResourceValues) } -> {"Type" :: NullOrUndefined.NullOrUndefined (String) , "Values" :: NullOrUndefined.NullOrUndefined (DataResourceValues) } ) -> DataResource
...
--   This may be useful if you need to immediately overwrite some of the optional values
newDescribeTrailsRequest' :: ( { "trailNameList" :: NullOrUndefined.NullOrUndefined (TrailNameList) , "includeShadowTrails" :: NullOrUndefined.NullOrUndefined (Boolean) } -> {"trailNameList" :: NullOrUndefined.NullOrUndefined (TrailNameList) , "includeShadowTrails" :: NullOrUndefined.NullOrUndefined (Boolean) } ) -> DescribeTrailsRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newDescribeTrailsResponse' :: ( { "trailList" :: NullOrUndefined.NullOrUndefined (TrailList) } -> {"trailList" :: NullOrUndefined.NullOrUndefined (TrailList) } ) -> DescribeTrailsResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newEvent' :: ( { "EventId" :: NullOrUndefined.NullOrUndefined (String) , "EventName" :: NullOrUndefined.NullOrUndefined (String) , "EventTime" :: NullOrUndefined.NullOrUndefined (Date) , "EventSource" :: NullOrUndefined.NullOrUndefined (String) , "Username" :: NullOrUndefined.NullOrUndefined (String) , "Resources" :: NullOrUndefined.NullOrUndefined (ResourceList) , "CloudTrailEvent" :: NullOrUndefined.NullOrUndefined (String) } -> {"EventId" :: NullOrUndefined.NullOrUndefined (String) , "EventName" :: NullOrUndefined.NullOrUndefined (String) , "EventTime" :: NullOrUndefined.NullOrUndefined (Date) , "EventSource" :: NullOrUndefined.NullOrUndefined (String) , "Username" :: NullOrUndefined.NullOrUndefined (String) , "Resources" :: NullOrUndefined.NullOrUndefined (ResourceList) , "CloudTrailEvent" :: NullOrUndefined.NullOrUndefined (String) } ) -> Event
...
--   This may be useful if you need to immediately overwrite some of the optional values
newEventSelector' :: ( { "ReadWriteType" :: NullOrUndefined.NullOrUndefined (ReadWriteType) , "IncludeManagementEvents" :: NullOrUndefined.NullOrUndefined (Boolean) , "DataResources" :: NullOrUndefined.NullOrUndefined (DataResources) } -> {"ReadWriteType" :: NullOrUndefined.NullOrUndefined (ReadWriteType) , "IncludeManagementEvents" :: NullOrUndefined.NullOrUndefined (Boolean) , "DataResources" :: NullOrUndefined.NullOrUndefined (DataResources) } ) -> EventSelector
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetEventSelectorsResponse' :: ( { "TrailARN" :: NullOrUndefined.NullOrUndefined (String) , "EventSelectors" :: NullOrUndefined.NullOrUndefined (EventSelectors) } -> {"TrailARN" :: NullOrUndefined.NullOrUndefined (String) , "EventSelectors" :: NullOrUndefined.NullOrUndefined (EventSelectors) } ) -> GetEventSelectorsResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetTrailStatusResponse' :: ( { "IsLogging" :: NullOrUndefined.NullOrUndefined (Boolean) , "LatestDeliveryError" :: NullOrUndefined.NullOrUndefined (String) , "LatestNotificationError" :: NullOrUndefined.NullOrUndefined (String) , "LatestDeliveryTime" :: NullOrUndefined.NullOrUndefined (Date) , "LatestNotificationTime" :: NullOrUndefined.NullOrUndefined (Date) , "StartLoggingTime" :: NullOrUndefined.NullOrUndefined (Date) , "StopLoggingTime" :: NullOrUndefined.NullOrUndefined (Date) , "LatestCloudWatchLogsDeliveryError" :: NullOrUndefined.NullOrUndefined (String) , "LatestCloudWatchLogsDeliveryTime" :: NullOrUndefined.NullOrUndefined (Date) , "LatestDigestDeliveryTime" :: NullOrUndefined.NullOrUndefined (Date) , "LatestDigestDeliveryError" :: NullOrUndefined.NullOrUndefined (String) , "LatestDeliveryAttemptTime" :: NullOrUndefined.NullOrUndefined (String) , "LatestNotificationAttemptTime" :: NullOrUndefined.NullOrUndefined (String) , "LatestNotificationAttemptSucceeded" :: NullOrUndefined.NullOrUndefined (String) , "LatestDeliveryAttemptSucceeded" :: NullOrUndefined.NullOrUndefined (String) , "TimeLoggingStarted" :: NullOrUndefined.NullOrUndefined (String) , "TimeLoggingStopped" :: NullOrUndefined.NullOrUndefined (String) } -> {"IsLogging" :: NullOrUndefined.NullOrUndefined (Boolean) , "LatestDeliveryError" :: NullOrUndefined.NullOrUndefined (String) , "LatestNotificationError" :: NullOrUndefined.NullOrUndefined (String) , "LatestDeliveryTime" :: NullOrUndefined.NullOrUndefined (Date) , "LatestNotificationTime" :: NullOrUndefined.NullOrUndefined (Date) , "StartLoggingTime" :: NullOrUndefined.NullOrUndefined (Date) , "StopLoggingTime" :: NullOrUndefined.NullOrUndefined (Date) , "LatestCloudWatchLogsDeliveryError" :: NullOrUndefined.NullOrUndefined (String) , "LatestCloudWatchLogsDeliveryTime" :: NullOrUndefined.NullOrUndefined (Date) , "LatestDigestDeliveryTime" :: NullOrUndefined.NullOrUndefined (Date) , "LatestDigestDeliveryError" :: NullOrUndefined.NullOrUndefined (String) , "LatestDeliveryAttemptTime" :: NullOrUndefined.NullOrUndefined (String) , "LatestNotificationAttemptTime" :: NullOrUndefined.NullOrUndefined (String) , "LatestNotificationAttemptSucceeded" :: NullOrUndefined.NullOrUndefined (String) , "LatestDeliveryAttemptSucceeded" :: NullOrUndefined.NullOrUndefined (String) , "TimeLoggingStarted" :: NullOrUndefined.NullOrUndefined (String) , "TimeLoggingStopped" :: NullOrUndefined.NullOrUndefined (String) } ) -> GetTrailStatusResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newListPublicKeysRequest' :: ( { "StartTime" :: NullOrUndefined.NullOrUndefined (Date) , "EndTime" :: NullOrUndefined.NullOrUndefined (Date) , "NextToken" :: NullOrUndefined.NullOrUndefined (String) } -> {"StartTime" :: NullOrUndefined.NullOrUndefined (Date) , "EndTime" :: NullOrUndefined.NullOrUndefined (Date) , "NextToken" :: NullOrUndefined.NullOrUndefined (String) } ) -> ListPublicKeysRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newListPublicKeysResponse' :: ( { "PublicKeyList" :: NullOrUndefined.NullOrUndefined (PublicKeyList) , "NextToken" :: NullOrUndefined.NullOrUndefined (String) } -> {"PublicKeyList" :: NullOrUndefined.NullOrUndefined (PublicKeyList) , "NextToken" :: NullOrUndefined.NullOrUndefined (String) } ) -> ListPublicKeysResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newListTagsRequest' :: ResourceIdList -> ( { "ResourceIdList" :: (ResourceIdList) , "NextToken" :: NullOrUndefined.NullOrUndefined (String) } -> {"ResourceIdList" :: (ResourceIdList) , "NextToken" :: NullOrUndefined.NullOrUndefined (String) } ) -> ListTagsRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newListTagsResponse' :: ( { "ResourceTagList" :: NullOrUndefined.NullOrUndefined (ResourceTagList) , "NextToken" :: NullOrUndefined.NullOrUndefined (String) } -> {"ResourceTagList" :: NullOrUndefined.NullOrUndefined (ResourceTagList) , "NextToken" :: NullOrUndefined.NullOrUndefined (String) } ) -> ListTagsResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newLookupEventsRequest' :: ( { "LookupAttributes" :: NullOrUndefined.NullOrUndefined (LookupAttributesList) , "StartTime" :: NullOrUndefined.NullOrUndefined (Date) , "EndTime" :: NullOrUndefined.NullOrUndefined (Date) , "MaxResults" :: NullOrUndefined.NullOrUndefined (MaxResults) , "NextToken" :: NullOrUndefined.NullOrUndefined (NextToken) } -> {"LookupAttributes" :: NullOrUndefined.NullOrUndefined (LookupAttributesList) , "StartTime" :: NullOrUndefined.NullOrUndefined (Date) , "EndTime" :: NullOrUndefined.NullOrUndefined (Date) , "MaxResults" :: NullOrUndefined.NullOrUndefined (MaxResults) , "NextToken" :: NullOrUndefined.NullOrUndefined (NextToken) } ) -> LookupEventsRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newLookupEventsResponse' :: ( { "Events" :: NullOrUndefined.NullOrUndefined (EventsList) , "NextToken" :: NullOrUndefined.NullOrUndefined (NextToken) } -> {"Events" :: NullOrUndefined.NullOrUndefined (EventsList) , "NextToken" :: NullOrUndefined.NullOrUndefined (NextToken) } ) -> LookupEventsResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPublicKey' :: ( { "Value" :: NullOrUndefined.NullOrUndefined (ByteBuffer) , "ValidityStartTime" :: NullOrUndefined.NullOrUndefined (Date) , "ValidityEndTime" :: NullOrUndefined.NullOrUndefined (Date) , "Fingerprint" :: NullOrUndefined.NullOrUndefined (String) } -> {"Value" :: NullOrUndefined.NullOrUndefined (ByteBuffer) , "ValidityStartTime" :: NullOrUndefined.NullOrUndefined (Date) , "ValidityEndTime" :: NullOrUndefined.NullOrUndefined (Date) , "Fingerprint" :: NullOrUndefined.NullOrUndefined (String) } ) -> PublicKey
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPutEventSelectorsResponse' :: ( { "TrailARN" :: NullOrUndefined.NullOrUndefined (String) , "EventSelectors" :: NullOrUndefined.NullOrUndefined (EventSelectors) } -> {"TrailARN" :: NullOrUndefined.NullOrUndefined (String) , "EventSelectors" :: NullOrUndefined.NullOrUndefined (EventSelectors) } ) -> PutEventSelectorsResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newRemoveTagsRequest' :: String -> ( { "ResourceId" :: (String) , "TagsList" :: NullOrUndefined.NullOrUndefined (TagsList) } -> {"ResourceId" :: (String) , "TagsList" :: NullOrUndefined.NullOrUndefined (TagsList) } ) -> RemoveTagsRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newResource' :: ( { "ResourceType" :: NullOrUndefined.NullOrUndefined (String) , "ResourceName" :: NullOrUndefined.NullOrUndefined (String) } -> {"ResourceType" :: NullOrUndefined.NullOrUndefined (String) , "ResourceName" :: NullOrUndefined.NullOrUndefined (String) } ) -> Resource
...
--   This may be useful if you need to immediately overwrite some of the optional values
newResourceTag' :: ( { "ResourceId" :: NullOrUndefined.NullOrUndefined (String) , "TagsList" :: NullOrUndefined.NullOrUndefined (TagsList) } -> {"ResourceId" :: NullOrUndefined.NullOrUndefined (String) , "TagsList" :: NullOrUndefined.NullOrUndefined (TagsList) } ) -> ResourceTag
...
--   This may be useful if you need to immediately overwrite some of the optional values
newTag' :: String -> ( { "Key" :: (String) , "Value" :: NullOrUndefined.NullOrUndefined (String) } -> {"Key" :: (String) , "Value" :: NullOrUndefined.NullOrUndefined (String) } ) -> Tag
...
--   This may be useful if you need to immediately overwrite some of the optional values
newTrail' :: ( { "Name" :: NullOrUndefined.NullOrUndefined (String) , "S3BucketName" :: NullOrUndefined.NullOrUndefined (String) , "S3KeyPrefix" :: NullOrUndefined.NullOrUndefined (String) , "SnsTopicName" :: NullOrUndefined.NullOrUndefined (String) , "SnsTopicARN" :: NullOrUndefined.NullOrUndefined (String) , "IncludeGlobalServiceEvents" :: NullOrUndefined.NullOrUndefined (Boolean) , "IsMultiRegionTrail" :: NullOrUndefined.NullOrUndefined (Boolean) , "HomeRegion" :: NullOrUndefined.NullOrUndefined (String) , "TrailARN" :: NullOrUndefined.NullOrUndefined (String) , "LogFileValidationEnabled" :: NullOrUndefined.NullOrUndefined (Boolean) , "CloudWatchLogsLogGroupArn" :: NullOrUndefined.NullOrUndefined (String) , "CloudWatchLogsRoleArn" :: NullOrUndefined.NullOrUndefined (String) , "KmsKeyId" :: NullOrUndefined.NullOrUndefined (String) , "HasCustomEventSelectors" :: NullOrUndefined.NullOrUndefined (Boolean) } -> {"Name" :: NullOrUndefined.NullOrUndefined (String) , "S3BucketName" :: NullOrUndefined.NullOrUndefined (String) , "S3KeyPrefix" :: NullOrUndefined.NullOrUndefined (String) , "SnsTopicName" :: NullOrUndefined.NullOrUndefined (String) , "SnsTopicARN" :: NullOrUndefined.NullOrUndefined (String) , "IncludeGlobalServiceEvents" :: NullOrUndefined.NullOrUndefined (Boolean) , "IsMultiRegionTrail" :: NullOrUndefined.NullOrUndefined (Boolean) , "HomeRegion" :: NullOrUndefined.NullOrUndefined (String) , "TrailARN" :: NullOrUndefined.NullOrUndefined (String) , "LogFileValidationEnabled" :: NullOrUndefined.NullOrUndefined (Boolean) , "CloudWatchLogsLogGroupArn" :: NullOrUndefined.NullOrUndefined (String) , "CloudWatchLogsRoleArn" :: NullOrUndefined.NullOrUndefined (String) , "KmsKeyId" :: NullOrUndefined.NullOrUndefined (String) , "HasCustomEventSelectors" :: NullOrUndefined.NullOrUndefined (Boolean) } ) -> Trail
...
--   This may be useful if you need to immediately overwrite some of the optional values
newUpdateTrailRequest' :: String -> ( { "Name" :: (String) , "S3BucketName" :: NullOrUndefined.NullOrUndefined (String) , "S3KeyPrefix" :: NullOrUndefined.NullOrUndefined (String) , "SnsTopicName" :: NullOrUndefined.NullOrUndefined (String) , "IncludeGlobalServiceEvents" :: NullOrUndefined.NullOrUndefined (Boolean) , "IsMultiRegionTrail" :: NullOrUndefined.NullOrUndefined (Boolean) , "EnableLogFileValidation" :: NullOrUndefined.NullOrUndefined (Boolean) , "CloudWatchLogsLogGroupArn" :: NullOrUndefined.NullOrUndefined (String) , "CloudWatchLogsRoleArn" :: NullOrUndefined.NullOrUndefined (String) , "KmsKeyId" :: NullOrUndefined.NullOrUndefined (String) } -> {"Name" :: (String) , "S3BucketName" :: NullOrUndefined.NullOrUndefined (String) , "S3KeyPrefix" :: NullOrUndefined.NullOrUndefined (String) , "SnsTopicName" :: NullOrUndefined.NullOrUndefined (String) , "IncludeGlobalServiceEvents" :: NullOrUndefined.NullOrUndefined (Boolean) , "IsMultiRegionTrail" :: NullOrUndefined.NullOrUndefined (Boolean) , "EnableLogFileValidation" :: NullOrUndefined.NullOrUndefined (Boolean) , "CloudWatchLogsLogGroupArn" :: NullOrUndefined.NullOrUndefined (String) , "CloudWatchLogsRoleArn" :: NullOrUndefined.NullOrUndefined (String) , "KmsKeyId" :: NullOrUndefined.NullOrUndefined (String) } ) -> UpdateTrailRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newUpdateTrailResponse' :: ( { "Name" :: NullOrUndefined.NullOrUndefined (String) , "S3BucketName" :: NullOrUndefined.NullOrUndefined (String) , "S3KeyPrefix" :: NullOrUndefined.NullOrUndefined (String) , "SnsTopicName" :: NullOrUndefined.NullOrUndefined (String) , "SnsTopicARN" :: NullOrUndefined.NullOrUndefined (String) , "IncludeGlobalServiceEvents" :: NullOrUndefined.NullOrUndefined (Boolean) , "IsMultiRegionTrail" :: NullOrUndefined.NullOrUndefined (Boolean) , "TrailARN" :: NullOrUndefined.NullOrUndefined (String) , "LogFileValidationEnabled" :: NullOrUndefined.NullOrUndefined (Boolean) , "CloudWatchLogsLogGroupArn" :: NullOrUndefined.NullOrUndefined (String) , "CloudWatchLogsRoleArn" :: NullOrUndefined.NullOrUndefined (String) , "KmsKeyId" :: NullOrUndefined.NullOrUndefined (String) } -> {"Name" :: NullOrUndefined.NullOrUndefined (String) , "S3BucketName" :: NullOrUndefined.NullOrUndefined (String) , "S3KeyPrefix" :: NullOrUndefined.NullOrUndefined (String) , "SnsTopicName" :: NullOrUndefined.NullOrUndefined (String) , "SnsTopicARN" :: NullOrUndefined.NullOrUndefined (String) , "IncludeGlobalServiceEvents" :: NullOrUndefined.NullOrUndefined (Boolean) , "IsMultiRegionTrail" :: NullOrUndefined.NullOrUndefined (Boolean) , "TrailARN" :: NullOrUndefined.NullOrUndefined (String) , "LogFileValidationEnabled" :: NullOrUndefined.NullOrUndefined (Boolean) , "CloudWatchLogsLogGroupArn" :: NullOrUndefined.NullOrUndefined (String) , "CloudWatchLogsRoleArn" :: NullOrUndefined.NullOrUndefined (String) , "KmsKeyId" :: NullOrUndefined.NullOrUndefined (String) } ) -> UpdateTrailResponse
